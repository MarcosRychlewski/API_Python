...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('atracoes', '0002_alter_atracao_tipo'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('localizacao', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='localizacao.localizacao')),
            ],
        ),
    ]
